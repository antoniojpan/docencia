---
{"dg-publish":true,"permalink":"/04-mat-ii-qui/apuntes/tema-2-metodos-numericos-en-ecuaciones-de-una-variable/","created":"2026-01-08T10:24:16.931+01:00","updated":"2025-09-15T10:05:23.138+02:00"}
---


[[04 MatII-Qui/Matemáticas II- Química- Índice\|Volver al temario]].
# Tema 2. Métodos numéricos en ecuaciones de una variable
- [[04 MatII-Qui/Apuntes/Tema 2. Métodos numéricos en ecuaciones de una variable#1. Introducción\|1. Introducción]]
- [[04 MatII-Qui/Apuntes/Tema 2. Métodos numéricos en ecuaciones de una variable#2. Separación de los ceros de una función\|2. Separación de los ceros de una función]]
	- [[04 MatII-Qui/Apuntes/Tema 2. Métodos numéricos en ecuaciones de una variable#2. Separación de los ceros de una función\|Proceso para encontrar los intervalos deseados:]]
	- [[04 MatII-Qui/Apuntes/Tema 2. Métodos numéricos en ecuaciones de una variable#2. Separación de los ceros de una función\|Ejemplos]]
- [[04 MatII-Qui/Apuntes/Tema 2. Métodos numéricos en ecuaciones de una variable#3. Método de la bisección\|3. Método de la bisección]]
	- [[04 MatII-Qui/Apuntes/Tema 2. Métodos numéricos en ecuaciones de una variable#3. Método de la bisección\|Pasos del método:]]
	- [[04 MatII-Qui/Apuntes/Tema 2. Métodos numéricos en ecuaciones de una variable#3. Método de la bisección\|Ventajas y desventajas:]]
	- [[04 MatII-Qui/Apuntes/Tema 2. Métodos numéricos en ecuaciones de una variable#3. Método de la bisección\|Ejemplo]]
- [[04 MatII-Qui/Apuntes/Tema 2. Métodos numéricos en ecuaciones de una variable#4. Método de la “regula falsi”\|4. Método de la “regula falsi”]]
	- [[04 MatII-Qui/Apuntes/Tema 2. Métodos numéricos en ecuaciones de una variable#4. Método de la “regula falsi”\|Pasos del método:]]
	- [[04 MatII-Qui/Apuntes/Tema 2. Métodos numéricos en ecuaciones de una variable#4. Método de la “regula falsi”\|Criterio de paro:]]
	- [[04 MatII-Qui/Apuntes/Tema 2. Métodos numéricos en ecuaciones de una variable#4. Método de la “regula falsi”\|Ventajas y desventajas:]]
	- [[04 MatII-Qui/Apuntes/Tema 2. Métodos numéricos en ecuaciones de una variable#4. Método de la “regula falsi”\|Ejemplo]]
- [[04 MatII-Qui/Apuntes/Tema 2. Métodos numéricos en ecuaciones de una variable#5. Método de Newton-Raphson\|5. Método de Newton-Raphson]]
	- [[04 MatII-Qui/Apuntes/Tema 2. Métodos numéricos en ecuaciones de una variable#5. Método de Newton-Raphson\|Pasos del método:]]
	- [[04 MatII-Qui/Apuntes/Tema 2. Métodos numéricos en ecuaciones de una variable#5. Método de Newton-Raphson\|Criterio de paro:]]
	- [[04 MatII-Qui/Apuntes/Tema 2. Métodos numéricos en ecuaciones de una variable#5. Método de Newton-Raphson\|Ventajas y desventajas:]]
	- [[04 MatII-Qui/Apuntes/Tema 2. Métodos numéricos en ecuaciones de una variable#5. Método de Newton-Raphson\|Ejemplo]]
- [[04 MatII-Qui/Apuntes/Tema 2. Métodos numéricos en ecuaciones de una variable#6. Actividad académicamente dirigida\|6. Actividad académicamente dirigida]]
...
### Pasos del método:
8. Tomamos el punto medio del intervalo $[a_n, b_n]$:
$$
 c_n = \frac{a_n + b_n}{2}
 $$
9. Si $f(c_n) = 0$, entonces $x = c_n$ y hemos terminado.
10. Si $f(c_n) \neq 0$, entonces:
