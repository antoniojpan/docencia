---
{"dg-publish":true,"permalink":"/04-mat-ii-qui/apuntes/anexo-hoja-formulas/","created":"2026-01-08T10:24:16.932+01:00","updated":"2025-09-15T10:05:23.090+02:00"}
---
...
| ----------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------- |
| **Bisección** (Criterio de paro)    | $\frac{b - a}{2^{n+1}} < \varepsilon$                                                                                                | —                                                                   |
| **Regula Falsi** (Iteración)        | $c = b - \frac{b - a}{f(b) - f(a)} f(b)$                                                                                             | —                                                                   |
| **Newton-Raphson** (Iteración)      | $x_{1} = x_0 - \frac{f(x_0)}{f'(x_0)}$                                                                                               | —                                                                   |
| **Regla Punto Medio**               | $2h \sum_{i=1}^{n} f(x_{2i-1}),\quad h=\frac{b-a}{2n}$                                                                               | $E_{Pm}(f)\leq \frac{(b - a)^3}{24n^2} \max_{x \in [a, b]}f''(x)$   |
